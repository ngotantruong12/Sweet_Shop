<?php 
include "connect.php";
$sql = "select * from sanpham where Gene='Women' and TinhTrang='Flash'  ";
$result = mysqli_query ($conn, $sql);
?>
<div name="" class="">
<h3 style=" Text-align: center; background-color: antiquewhite; margin: 20px 0px 10px 0px;">DANH SÁCH CÁC SẢN PHẨM NỮ BÁN CHẠY</h3>
